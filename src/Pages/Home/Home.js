      ...
      <section class="right">
        <section id="about">
          ...
          I am a highly motivated undergraduate HCI researcher at <img src={'images/nupzuk.png'} style={{ height: '1em', verticalAlign: 'middle' }}/> <a href="https://cs.kaist.ac.kr" className="kaist"target="_blank">
              ...
              I was also incredibly lucky to be mentored by <a href="https://galaxytourist.notion.site/galaxytourist/Hwajung-Hong-cc10b0291bbe4ca38dbf4882cd687423" target="_blank" id="name">Dr. Hwajung Hong</a>, <a href="https://www.jangheecho.com/" target="_blank" id="name">Dr. Janghee Cho</a>, <a href="http://juhokim.com" target="_blank" id="name">Dr. Juho Kim</a>, and <a href="https://sachinpendse.in" target="_blank" id="name">Dr. Sachin R. Pendse</a>, who all inspired my love and devotion to research 💚.   
          </div>
          <div>

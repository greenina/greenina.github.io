    ...
    <div className='home-layout'>
      ...
      <section class="right">
        <section id="about">
          ...
          These interests guide my work as a highly motivated undergraduate HCI researcher at <img src={'images/nupzuk.png'} style={{ height: '1em', verticalAlign: 'middle' }}/> <a href="https://cs.kaist.ac.kr" className="kaist">

    ...
    <div className='home-layout'>
      ...
      <section class="right">
        <section id="about">
          ...
          These interests guide my work as a highly motivated undergraduate HCI researcher at <img src={'images/nupzuk.png'} style={{ height: '1em', verticalAlign: 'middle' }}/> <a href="https://cs.kaist.ac.kr">
                KAIST School of Computing
              </a>, currently a research intern at <img src={'images/naver.png'} style={{ height: '1em', verticalAlign: 'middle' }}/> <a href="https://naver-career.gitbook.io/en/teams/clova-cic/ai-lab" target="_blank">NAVER AI Lab</a>, where I am fortunate to be
              mentored by <a href="http://younghokim.net" target="_blank">Dr. Young-Ho Kim</a>. I've been advised by <a href="http://munmund.net" target="_blank">Dr. Munmun De Choudhury</a> at <img src={'images/gtbee.svg'} style={{ height: '1em', verticalAlign: 'middle' }}/> <a href="https://www.cc.gatech.edu/" target="_blank"> Georgia Tech</a>, and
